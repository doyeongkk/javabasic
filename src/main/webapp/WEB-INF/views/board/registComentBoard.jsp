            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">게시글 등록 페이지</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">게시글을 등록해주세요!</li>
                        </ol>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form id="frm" action="${cp}/board/comentBoardPost" method="post" enctype="multipart/form-data">
                            		<input type="hidden" name="cBoardNo" value="${cBoardNo}">
                            		<input type="hidden" name="userId" value="${S_USER.userid}">
                            		<input type="hidden" name="cPostNo" value="${cPostNo}">
	                                ...
	                                <div class="table-responsive">
	                                	...
	                                	<div>
	                                		<input type="button" id="registBoard"  style="float: right;" value="등록하기"><br>
	                                	</div>
	                                </div>
                                </form>
                            </div>
