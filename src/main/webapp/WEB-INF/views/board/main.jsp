                        ...
                        <div class="nav">
                            ...
                            <a class="nav-link" href="${cp}/board/registBoardInfo">
                                <div class="sb-nav-link-icon">
                                	<img src="${cp}/profile?userid=${S_USER.userid}" style="width: 40px; height: 40px;" class="img-circle elevation-2" alt="User Image">
                                </div> 
                                ${S_USER.usernm}
                            </a>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">게시판사이트 입니다</li>
                        </ol>
...
<%--                                 	<img width="100%" height="100%" alt="배경" src="${cp}/resources/images/view.jpg"> --%>
                                </div>
                            </div>
                        </div>
                    </div>
