...
public class CommentVo {
	...
	public int getRep_com_no() {
		return rep_com_no;
	}
	public void setRep_com_no(int rep_com_no) {
		this.rep_com_no = rep_com_no;
	}
	...
	public String toString() {
		return "CommentVo [com_no=" + com_no + ", com_user_id=" + com_user_id + ", com_date=" + com_date + ", com_con="
				+ com_con + ", com_del=" + com_del + ", rep_com_no=" + rep_com_no + ", com_com_user_id="
