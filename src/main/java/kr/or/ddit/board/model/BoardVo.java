...
public class BoardVo {
	...
	public BoardVo(int bor_no, int post_no, String user_id, String title, String cont, Date reg_dt, int post_del,
	...
	public String toString() {
		return "BoardVo [bor_no=" + bor_no + ", post_no=" + post_no + ", user_id=" + user_id + ", title=" + title
